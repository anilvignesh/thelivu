...
1. **Scan the beat.** Priority order is Kerala → India → global, reflecting the audience — but this is priority, not a hard limit. A global story where dominant media is distorting the picture and an Indian reader needs the truth is in scope. Match the geographic frame to the evidence and impact: a national water crisis is an India story; a specific government contract is a Kerala story; US media capture of the Iran war narrative is a global story. Do not force a Kerala angle onto India or global stories. Search across the spectrum — mainstream outlets, regional-language press, independent newsrooms, primary sources (government data, court listings, regulatory filings, company disclosures), and partisan outlets (as lead sources only).
